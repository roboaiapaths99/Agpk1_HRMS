...
class UserRepository:
    ...
    async def update_user(self, user_id: str, update_data: dict, modified_by: str = None) -> Optional[User]:
        """Update user details"""
    ...
    async def get_user_login_history(self, user_id: str, limit: int = 50) -> List[dict]:
        """Get user login history (placeholder - would integrate with activity logs)"""
    ...
    async def update_last_login(self, user_id: str, ip_address: str = None) -> Optional[User]:
