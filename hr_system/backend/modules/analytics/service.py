...
from .model import (
    AnalyticsMetric, Dashboard, Report, Alert, AlertHistory, 
    UserActivity, SystemMetrics, DataQualityMetrics,
...
class AnalyticsService:
    ...
    async def record_metric(
        ...
        try:
            ...
            previous_metric = await AnalyticsMetric.find_one(
                {
                    "name": name,
                    "category": category,
    ...
    async def get_metrics(
        ...
        try:
            ...
            # Get metrics
            metrics = await AnalyticsMetric.find(query).sort("-period_start").limit(limit).to_list()
    ...
    async def create_dashboard(
        ...
        try:
            ...
            audit_logger.log_user_action(
                created_by or "system", "dashboard_created", str(dashboard.id),
    ...
    async def get_dashboards(
        ...
        try:
            ...
            dashboards = await Dashboard.find(query).sort("title").to_list()
    ...
    async def track_user_activity(
        ...
        try:
            ...
            print(f"Failed to track user activity: {str(e)}")
            return None
